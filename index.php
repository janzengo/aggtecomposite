            ...
            <div class="section-title">
              ...
              <div class="about-description">
                <ul>
                  ...
                  <li>NEED SEASONAL PAINTING, SEALING OR STAINING</li>
                  <li>FADE OR STAIN</li>
                  <li>BECOME FOOD FOR TERMITES</li>
                </ul>
                <div class="readmore">
                  <a href="about.php#advantage"><button class="main-btn btn-1 btn-1e">See Advantages</button></a>
                </div>
              </div>
            </div>
    ...
    <section class="services bg-gray">
      ...
      <div class="container">
            ...
            <div class="single-item">
              <div class="fig_caption">
                ...
                <div class="details">
                  ...
                  <p> An excellent composite decking product will provide any outdoor space with a genuine-modern
                    finish, including a wide variety of features that will ensure your protection and peace of mind in
                    the years to come, thus, giving you’re the privilege of enjoying the sight of your deck area.
                    <br><br>
            ...
            <div class="single-item">
              <div class="fig_caption">
                ...
                <div class="details">
                  ...
                  <p>AGGTEDeck Builders is an independently owned and operated company. The company and its sales agents
                    or representatives are not in any way connected with AGGTEDeck Composite Cladding & Decking. As
                    such, AGGTEDeck Composite Cladding & Decking does not make any representations or warranties as to
                    the services of AGGTEDeck Builders. They are also not responsible for the performance, acts or
                    omissions of AGGTEDeck Composite Cladding & Decking Builders.<br><br>
                    As an independent company, AGGTE Builders have undergone advanced training by joining a very
                    carefully chosen group of installer with extensive and state-of the art experience in the field of
                    WPC Cladding and Decking experience. Through it, AGGTEDeck clients are assured that their concerns
                    can be effectively handled by the very competent members of the company’s management and staff.
                  </p><br>
                </div>
              </div>
            </div>
        ...
        <div class="readmore text-center">
          <a href="services.php"><button class="main-btn btn-1 btn-1e">All Services</button></a>
        </div>
      </div>
      <!--container end-->
    </section>
    ...
    <section class="bg-gray portfolio-area">
      ...
      <div class="container-fluid">
        <div class="section-title">
          ...
          <p>Here's our latest and most commendable <a href="projects.php">projects</a> all throughout the year <?php echo date("Y") ?>.
            The portfolio are shown based on the comments of clients
        ...
        <div class="portfolio-inner">
         ...
         <!--col end-->
            ...
            <!--col start-->
            <li class="col-md-3 col-sm-6 col-xs-12 nf-item gates">
              <div class="image-hover-effect-4"> <img src="images/gallery/gates/gate_e.jpg" alt="img-12">
                <div class="caption">
                  <h3>WPC Gates</h3>
                  <p>Las Piñas</p>
                </div>
          ...
          <div class="col-md-6">
            <div class="section-title">
              ...
              <p> We strongly believe that our products are easy to install. As a matter of fact, its assembly does not
                ...
                exterior set-up without consuming much of your time. Here at <a href="services.php">AGGTEdeck Composite
                  Cladding and Decking</a>, minimizing waste and ensuring sustainability are our top priorities because
                our AGGTE calculator can precisely provide you with the exact materials that you will need to complete
                your project.</p>
              <br>
              <p> Furthermore, our wood composite materials are guaranteed to be more lasting than wood. It has
                additives that make the existing hard wood properties more sturdy which indicates that you can be
                assured that your <a target="_blank" href="https://en.wikipedia.org/wiki/Wood-plastic_composite">deck,
                  cladding or fencing</a> is more tough than other ordinary products. Also, our materials do not absorb
            ...
            <div class="whychoose-description">
              <ul class="row defRow">
                ...
                <li class="col-md-6">High Quality Materials</li>
              </ul>
            </div>
          </div>
          <!--col end-->
    ...
    <div class="testimonials-wrap">
      <div class="container">
        ...
        <ul class="owl-carousel">
          ...
          <li class="item">
            <div class="testiWrp">
              <p><span style="font-size: 150%;font-weight: bold">Highly recommended</span><br>Thank you! Pleasure making
                business with you!</p>
              <div class="clientInfo">
                <div class="name">Toto Aquino<span class="white_color">Engineer</span></div>
                <div class="clearfix"></div>
              </div>
            </div>
          </li>
          <li class="item">
            <div class="testiWrp">
              <p><span style="font-size: 150%;font-weight: bold">Beautifuly made!</span><br>I'm looking forward on doing
                business with you again. My plan next time is the renovation of my tiles. </p>
              <div class="clientInfo">
                <div class="name">Rayne Jacob Villanueva<span class="white_color">Architect</span></div>
                <div class="clearfix"></div>
              </div>
            </div>
          </li>
          <li class="item">
            <div class="testiWrp">
              <p><span style="font-size: 150%;font-weight: bold">Great Service!</span><br>I'm so glad that I found your
                company.</p>
              <div class="clientInfo">
                <div class="name">Cassie Yang<span class="white_color">CEO</span></div>
                <div class="clearfix"></div>
              </div>
            </div>
          </li>
          <li class="item">
            <div class="testiWrp">
              <p><span style="font-size: 150%;font-weight: bold">AGGTEDeck Composite Cladding & Decking saved the
