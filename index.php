    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="about-video-item">
          <div class="about-video-img"> <img src="images/welcome-1.jpg" alt="thumbnail"> <a href="media/homeVid.mp4" class="video-play mfp-iframe xs-video"><i class="fa fa-play"></i></a> </div>
        </div>
      </div>
      <!--col end-->
    </div>
    ...
    <ul class="owl-carousel">
      <li class="item">
        <div class="testiWrp">
          ...
          <p><span style="font-size: 150%;font-weight: bold">Highly recommended</span><br>Thank you! Pleasure making business with you!</p>
      ...
      <li class="item">
        <div class="testiWrp">
          <p><span style="font-size: 150%;font-weight: bold">Beautifuly made!</span><br>I'm looking forward on doing business with you again. My plan next time is the renovation of my tiles. </p>
          <div class="clientInfo">
      ...
      <li class="item">
        <div class="testiWrp">
          <p><span style="font-size: 150%;font-weight: bold">Great Service!</span><br>I'm so glad that I found your company.</p>
          <div class="clientInfo">
