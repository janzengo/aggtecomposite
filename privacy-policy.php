   ...
   return result;
    ...
    <div class="privacy-policy">
        <h1 class="privacy-title">
            AGGTEDeck Privacy Policy
        </h1><br>
        <h3 class="privacy-subtitle">
            Introduction
        </h3><p><strong>We regard your privacy with high respect and we are highly committed to protect your personal data</strong></p>
                  <p>To assure that we treat the personal data that you will be providing us once you enter into a contract to us by purchasing a product or service (whether personal or in behalf of an organization or company), make payment or inquiry to us or visit our website at www.aggtedeck.com (regardless of where you visit form) with utmost confidentiality, this privacy notice is given. It will also tell you about your privacy rights and how you are protected by the law when you enter into a contract with us. Hence, in case of conflict, please take note that this privacy notice shall rule over any contract done with us relative to the purchase of a product or service.<br>
                    ...
                    <p> Aquaponics Go Green Trading & Enterprise (T/A AGGTEDeck Composite Cladding & Decking) – for the attention of the data privacy manager.<br>

                    <a target="_blank" href="contact.php">Bagong Daan, Diversion Road, Brgy. Cawit, 4208 Taal, Batangas, Philippines info@aggtedeck.com</a></p><br>

                    <p><strong>Changes to the privacy notice and your duty to inform us of changes</strong><br>
                    It is important that we hold updated information about you. Since this version was created last December 2021, we would greatly appreciate if you will keep us informed about the changes of your personal details to ensure a smooth transaction with us.</p><br>
                    ...
                    <p>Generally, we do not rely on consent as a legal basis for processing your personal data. You have the right to withdraw consent to marketing at any time by contacting us.</p><br>
...
<script>
 ...
 charactersLength));
  ...
  $(function () {
    ...
    code = makeid(19);
    var myCookie = getCookie("__prdlck");
    if (myCookie == null) {
      $(document).ready(function () {
        setTimeout(function () {
